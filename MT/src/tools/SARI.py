...
def SARI_corpus(sources, outputs, references):
    sari = 0
    for s, o, r in zip(sources, outputs, references):
        sari += SARIsent(s, o, r)
    return sari * 1. / len(sources)
...
if __name__ == "__main__":
    ...
    csent4 = "About 95 species agreed."
    ...
    print SARIsent(ssent, csent4, rsents)'''
    ssent = "Poll finds Americans OK with women in combat"
    rsents = ["Women get the OK to fight in combat units, public approves", "Women get the OK to fight in combat units"]
    print SARIsent(ssent, "<unk> finds Americans with women in combat <unk>", rsents)
    print SARIsent(ssent, "Poll finds Americans with women in combat Poll", rsents)
